...
def TitanicLogistic():
	...
	countplot(data=titanic_data,x=target).set_title("Titanic : Survived and non survived passengers")
	show()
	...
	countplot(data=titanic_data,x=target,hue="Sex").set_title("Titanic : Survived and non survived passengers based on Gender")
	show()
	...
	countplot(data=titanic_data,x=target,hue="Pclass").set_title("Titanic : Survived and non survived passengers based on the passenger class")
	show()
	
	print("Visualization : Survived and non survived passengers based on Age")
	figure()
	titanic_data["Age"].plot.hist().set_title("Titanic : Survived and non survived passengers based on Age")
	show()
	
	print("Visualization : Survived and non survived passengers based on the Fare")
	figure()
	titanic_data["Fare"].plot.hist().set_title("Titanic : Survived and non survived passengers based on Fare")
	show()
